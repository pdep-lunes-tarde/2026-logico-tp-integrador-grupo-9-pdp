...
test("Si una persona presencia una hazaña la recuerda por el resto de su vida desde ese momento"):-
...
test("Si una persona escucho una canción sobre esa hazaña la recuerda por 15 años desde ese momento"):-
...
test("Si una persona leyó un libro sobre una hazaña, la recuerda por tantos años como paginas que tenga el libro"):-
...
test("Si en el pueblo en el que vive una persona se conmemora una hazaña con un dia festivo la recuerda por el resto de su vida desde ese momento"):-
    ...
    not(recuerda(denken, destruir_rey_demonio, 1400)).

test("Si en el pueblo en el que vive una persona hay una estatua que conmemora una hazaña, la recuerda si sigue estando en buen estado"):-
    recuerda(lawine, destruir_rey_demonio, 1400),
    not(recuerda(lawine, destruir_rey_demonio, 1390)).

test("Una hazaña esta corroborada si solo hay una versión de la misma"):-
    corroborada(rescatar_hermana_de_wirbel).
test("Una hazaña no esta corrobarada si hubo diferentes personas que la llevaron a cabo o diferente lugar en el que ocurrió la hazaña"):-
    not(corroborada(destruir_demonio_aura)).

test("Una hazaña pasa al olvido si ya nadie la recuerda ese año"):-
